...
public class Key
{
    public const string PACK1 = "app30_pack1";
    public const string PACK2 = "app30_pack2";
    public const string PACK3 = "app30_pack3";
    public const string PACK4 = "app30_pack4";


    public const string PACK1_REGISTER = "register_app30_pack1";
    public const string PACK2_REGISTER = "register_app30_pack2";
    public const string PACK3_REGISTER = "register_app30_pack3";
    public const string PACK4_REGISTER = "register_app30_pack4";
    public const string PACK5_REGISTER = "register_app30_pack5";
}
